...
@php
    ...
    elseif (str_contains($type, 'cinema') || str_contains($type, 'movie')) $themeClass = 'theme-cinema';
    elseif (str_contains($type, 'exhibition') || str_contains($type, 'museum') || str_contains($type, 'art')) $themeClass = 'theme-exhibition';
    elseif (str_contains($type, 'party') || str_contains($type, 'nightlife') || str_contains($type, 'club')) $themeClass = 'theme-nightlife';
@endphp
...
<div class="container py-5">
    <div class="text-center mb-5">
        ...
        <p class="lead text-secondary">Your order has been processed successfully. You can download your receipt and tickets below.</p>
    </div>
