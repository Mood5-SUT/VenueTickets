...
<body>
    ...
    <main style="padding-top: 80px;">
        <div class="container">
            @if(session('success'))
                <div class="alert alert-glass border-success text-success animate-in mb-4" style="background: rgba(40, 167, 69, 0.1);">
                    <i class="bi bi-check-circle-fill me-2"></i> {{ session('success') }}
                </div>
            @endif

            @if(session('error'))
                <div class="alert alert-glass border-danger text-danger animate-in mb-4" style="background: rgba(220, 53, 69, 0.1);">
                    <i class="bi bi-exclamation-triangle-fill me-2"></i> {{ session('error') }}
                </div>
            @endif

            @if(session('info'))
                <div class="alert alert-glass border-info text-info animate-in mb-4" style="background: rgba(23, 162, 184, 0.1);">
